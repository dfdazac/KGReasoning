...
def to_cmd(c, _path=None):
    ...
    command = f'PYTHONPATH=. python3 main.py --do_valid --do_test --data_path data/FB15k-237-q2b -n 1 -b 1000 -d 1000 -lr 0.1 ' \
              ...
              f'--cqd d2 --cqd-t-norm {c["t"]} {s_normalize} {s_sigmoid} --cqd-k {c["k"]} --cuda'
    return command


def to_logfile(c, path):
    outfile = "{}/eval_beaker_v1.{}.log".format(path, summary(c).replace("/", "_"))
    return outfile
